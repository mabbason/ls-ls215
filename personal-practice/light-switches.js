...
Write a function that takes one argument, the total number of switches, and returns 
...
console.log(lightsOn(30)); // [ 1, 4, 9, 16, 25 ]
...
function lightsOn(n) {
  ...
  while (pass <= n) {
    for (let i = pass - 1; i < lights.length; i += pass) {
